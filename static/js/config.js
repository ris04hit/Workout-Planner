...
export function buildConfigPayloadFromUI() {
  const config = {
    ...
    scoring: {
      ...
      family_recency_penalty:  getScoringNum('family_recency_penalty', 1.0),
      recency_decay:           getScoringNum('recency_decay', 0.65),
      min_score_threshold:     getScoringNum('min_score_threshold', 0),
    },
    muscle_weights:  {},
    pattern_limits:  {},
    weekly_targets:  {}
